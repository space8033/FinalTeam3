                    ...
                    <li>
                      <a class="dropdown-item" href="${pageContext.request.contextPath}/userModify">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-medium d-block">${empInfo.empinfo_name}</span>
	                            ...
	                            <li
	                              ...
	                              <div class="d-flex align-items-center">
	                                <div class="form-check">
	                                  <input class="email-list-item-input form-check-input" type="checkbox" id="${note.noteRead_no}" />
	                                  <label class="form-check-label" for="${note.noteRead_no}"></label>
	                                </div>
	                                <i
	                                ...
	                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
	                                  <span class="email-list-item-username me-2 h6">${note.note_sender}</span>
	                                ...
	                                <div class="email-list-item-meta ms-auto d-flex align-items-center">
	                                  ...
	                                  <small class="email-list-item-time text-muted">${note.note_createdAt}</small>
