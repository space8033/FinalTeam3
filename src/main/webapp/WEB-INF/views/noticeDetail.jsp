...
<title>eCommerce Add Product - Apps | Sneat - Bootstrap 5 HTML
      ...
      <div class="layout-container">
         ...
         <aside id="layout-menu"
            ...
            <div class="app-brand demo">
               ...
               </span> <span class="app-brand-text demo menu-text fw-bold ms-2">pms</span>
            ...
            <ul class="menu-inner py-1">
               ...
               <li class="menu-item active"><a
                  href="${pageContext.request.contextPath}/noticeList"
               ...
               <li class="menu-item"><a href="javascript:void(0);"
                  class="menu-link menu-toggle"> <i
                     class="menu-icon tf-icons bx bx-task"></i>
                     <div class="text-truncate">일정관리</div>
               </a>
                  <ul class="menu-sub">
                     <li class="menu-item"><a
                        href="${pageContext.request.contextPath}/teamCalendar"
                        class="menu-link">
               ...
               <!--관리자 메뉴-->
               <li class="menu-header small text-uppercase"><span
                  class="menu-header-text">ADMIN MENU</span></li>

               <li class="menu-item"><a
                  href="${pageContext.request.contextPath}/project/addProject"
                  class="menu-link"> <i class="menu-icon tf-icons bx bx-file"></i>
                     <div class="text-truncate">프로젝트 등록</div>
               </a></li>

               <li class="menu-item"><a
                  href="${pageContext.request.contextPath}/project/modifyProject"
                  class="menu-link"> <i class="menu-icon tf-icons bx bxs-edit"></i>
                                 ...
                                 <div class="card-body" style="padding-top: 0px;">
                                    ...
                                    <div>
                                       <div>
                                          <div>
                                             <p>
                                                <span style="font-size: 12px; display: none;">글
                                                   번호:</span> <span style="font-size: 12px; display: none;">${notice.notice_no}</span>
                                             </p>
